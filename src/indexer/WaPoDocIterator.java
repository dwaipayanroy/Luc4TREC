 ...
 * Removes ':', '_'
 * Tested Washington Post data used in TREC News track (trec-news.org).
 */
 ...
 * @author dwaipayan
 */
public class WaPoDocIterator extends DocumentProcessor implements Iterator<Document> {

    boolean     toRefine;           // true, if to remove html-tags and urls; default - false

    public WaPoDocIterator(File file) throws FileNotFoundException {
        docReader = new BufferedReader(new FileReader(file));
    }

    public WaPoDocIterator(File file, CommandLineIndexing obj) throws FileNotFoundException, IOException {
        docReader = new BufferedReader(new FileReader(file));
        this.analyzer = obj.analyzer;
    }

    public WaPoDocIterator(Analyzer analyzer, String toStore, String dumpPath, Properties prop) throws FileNotFoundException{
    ...
    public WaPoDocIterator(Analyzer analyzer, String toStore, String storeTermVector, String dumpPath, Properties prop) throws FileNotFoundException{
        this.analyzer = analyzer;
        this.toStore = toStore;
        this.dumpPath = dumpPath;
    ...
    public WaPoDocIterator(File file, Analyzer analyzer, Properties prop) throws FileNotFoundException, IOException {
        docReader = new BufferedReader(new FileReader(file));
        this.analyzer = analyzer;
    ...
    public WaPoDocIterator(File file, Analyzer analyzer, String toStore, String dumpPath) throws FileNotFoundException{
        docReader = new BufferedReader(new FileReader(file));
        this.analyzer = analyzer;
        this.toStore = toStore;
        this.dumpPath = dumpPath;
    ...
    public Document next() {
        ...
        try {
            ...
            Logger.getLogger(WaPoDocIterator.class.getName()).log(Level.SEVERE, null, ex);
        } 
